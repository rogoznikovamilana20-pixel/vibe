...
class VibeLocalizations {
  ...
  static const _localizedValues = {
    'ru': {
      ...
      'onboarding_security_title': 'Квантовая безопасность',
      ...
      'onboarding_security_text': 'Каждое сообщение шифруется постквантово. Безопасность на уровне governments.',
    ...
    'en': {
      ...
      'dialog_save': 'Save',
      'dialog_close': 'Close',
      'onboarding_security_title': 'Quantum Security',
      ...
      'onboarding_security_text': 'Every message is post-quantum encrypted. Government-level security.',
